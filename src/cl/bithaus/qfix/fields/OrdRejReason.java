...
public class OrdRejReason extends IntField {
	...
	public static final int INCORRECT_MAX_FLOOR_QUANTITY = 95;
	public static final int INVALID_ISSUER = 96;
	public static final int INVALID_DATE = 97;
	public static final int SELF_FILL_DENIED = 98;
