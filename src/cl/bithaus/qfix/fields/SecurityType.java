...
public class SecurityType extends StringField {
	...
	public static final String MONETARIO = "MON";
	public static final String CUOTAS_DE_FONDO_DE_INVERSION = "CFI";
	public static final String INSTRUMENTOS_INTERMEDIACION_FINANCIERA = "IIF";
	public static final String INSTRUMENTOS_RENTA_FIJA = "IRF";
