...
public class SecurityDefinitionRequest extends Message {
	...
	public SecurityDefinitionRequest(cl.bithaus.qfix.fields.SecurityReqID securityReqID, cl.bithaus.qfix.fields.SecurityRequestType securityRequestType) {
		this();
	...
	public void set(cl.bithaus.qfix.fields.SecurityRequestType value) {
		setField(value);
	}

	public cl.bithaus.qfix.fields.SecurityRequestType get(cl.bithaus.qfix.fields.SecurityRequestType value) throws FieldNotFound {
		getField(value);
		return value;
	}

	public cl.bithaus.qfix.fields.SecurityRequestType getSecurityRequestType() throws FieldNotFound {
		return get(new cl.bithaus.qfix.fields.SecurityRequestType());
	}

	public boolean isSet(cl.bithaus.qfix.fields.SecurityRequestType field) {
		return isSetField(field);
	}
