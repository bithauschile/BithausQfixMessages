...
public class News extends Message {
	...
	public News(cl.bithaus.qfix.fields.Headline headline, cl.bithaus.qfix.fields.NewsType newsType) {
		this();
		setField(headline);
		setField(newsType);
	}
	
	public void set(cl.bithaus.qfix.fields.OrigTime value) {
		setField(value);
	}

	public cl.bithaus.qfix.fields.OrigTime get(cl.bithaus.qfix.fields.OrigTime value) throws FieldNotFound {
		getField(value);
		return value;
	}

	public cl.bithaus.qfix.fields.OrigTime getOrigTime() throws FieldNotFound {
		return get(new cl.bithaus.qfix.fields.OrigTime());
	}

	public boolean isSet(cl.bithaus.qfix.fields.OrigTime field) {
	...
	public void set(cl.bithaus.qfix.fields.Urgency value) {
		setField(value);
	}

	public cl.bithaus.qfix.fields.Urgency get(cl.bithaus.qfix.fields.Urgency value) throws FieldNotFound {
		getField(value);
		return value;
	}

	public cl.bithaus.qfix.fields.Urgency getUrgency() throws FieldNotFound {
		return get(new cl.bithaus.qfix.fields.Urgency());
	}

	public boolean isSet(cl.bithaus.qfix.fields.Urgency field) {
		return isSetField(field);
	}
	...
	public void set(cl.bithaus.qfix.fields.Headline value) {
		setField(value);
	}

	public cl.bithaus.qfix.fields.Headline get(cl.bithaus.qfix.fields.Headline value) throws FieldNotFound {
		getField(value);
		return value;
	}

	public cl.bithaus.qfix.fields.Headline getHeadline() throws FieldNotFound {
		return get(new cl.bithaus.qfix.fields.Headline());
	}

	public boolean isSet(cl.bithaus.qfix.fields.Headline field) {
		return isSetField(field);
	}
	...
	public void set(cl.bithaus.qfix.fields.EncodedHeadlineLen value) {
		setField(value);
	}

	public cl.bithaus.qfix.fields.EncodedHeadlineLen get(cl.bithaus.qfix.fields.EncodedHeadlineLen value) throws FieldNotFound {
		getField(value);
		return value;
	}

	public cl.bithaus.qfix.fields.EncodedHeadlineLen getEncodedHeadlineLen() throws FieldNotFound {
		return get(new cl.bithaus.qfix.fields.EncodedHeadlineLen());
	}

	public boolean isSet(cl.bithaus.qfix.fields.EncodedHeadlineLen field) {
		return isSetField(field);
	}
	...
	public void set(cl.bithaus.qfix.fields.EncodedHeadline value) {
		setField(value);
	}

	public cl.bithaus.qfix.fields.EncodedHeadline get(cl.bithaus.qfix.fields.EncodedHeadline value) throws FieldNotFound {
		getField(value);
		return value;
	}

	public cl.bithaus.qfix.fields.EncodedHeadline getEncodedHeadline() throws FieldNotFound {
		return get(new cl.bithaus.qfix.fields.EncodedHeadline());
	}

	public boolean isSet(cl.bithaus.qfix.fields.EncodedHeadline field) {
		return isSetField(field);
	}
	...
	public static class NoRelatedSym extends Group {
		...
		static final long serialVersionUID = 20050617;
		private static final int[] ORDER = {55, 65, 48, 22, 454, 460, 461, 167, 762, 200, 541, 224, 225, 239, 226, 227, 228, 255, 543, 470, 471, 472, 240, 202, 947, 206, 231, 223, 207, 106, 348, 349, 107, 350, 351, 691, 667, 875, 876, 864, 873, 874, 10160, 10161, 10162, 10225, 10224, 10165, 10166, 10174, 10176, 10228, 10229, 0};
	...
	public void set(cl.bithaus.qfix.fields.LinesOfText value) {
		setField(value);
	}

	public cl.bithaus.qfix.fields.LinesOfText get(cl.bithaus.qfix.fields.LinesOfText value) throws FieldNotFound {
		getField(value);
		return value;
	}

	public cl.bithaus.qfix.fields.LinesOfText getLinesOfText() throws FieldNotFound {
		return get(new cl.bithaus.qfix.fields.LinesOfText());
	}

	public boolean isSet(cl.bithaus.qfix.fields.LinesOfText field) {
		return isSetField(field);
	}
	...
	public void set(cl.bithaus.qfix.fields.NewsType value) {
		setField(value);
	}

	public cl.bithaus.qfix.fields.NewsType get(cl.bithaus.qfix.fields.NewsType value) throws FieldNotFound {
		getField(value);
		return value;
	}

	public cl.bithaus.qfix.fields.NewsType getNewsType() throws FieldNotFound {
		return get(new cl.bithaus.qfix.fields.NewsType());
	}

	public boolean isSet(cl.bithaus.qfix.fields.NewsType field) {
		return isSetField(field);
	}

	public boolean isSetNewsType() {
		return isSetField(10144);
	}

	public void set(cl.bithaus.qfix.fields.NewsCode value) {
		setField(value);
	}

	public cl.bithaus.qfix.fields.NewsCode get(cl.bithaus.qfix.fields.NewsCode value) throws FieldNotFound {
		getField(value);
		return value;
	}

	public cl.bithaus.qfix.fields.NewsCode getNewsCode() throws FieldNotFound {
		return get(new cl.bithaus.qfix.fields.NewsCode());
	}

	public boolean isSet(cl.bithaus.qfix.fields.NewsCode field) {
		return isSetField(field);
	}

	public boolean isSetNewsCode() {
		return isSetField(10145);
	}

	public void set(cl.bithaus.qfix.fields.NewsSourceSystem value) {
		setField(value);
	}

	public cl.bithaus.qfix.fields.NewsSourceSystem get(cl.bithaus.qfix.fields.NewsSourceSystem value) throws FieldNotFound {
		getField(value);
		return value;
	}

	public cl.bithaus.qfix.fields.NewsSourceSystem getNewsSourceSystem() throws FieldNotFound {
		return get(new cl.bithaus.qfix.fields.NewsSourceSystem());
	}

	public boolean isSet(cl.bithaus.qfix.fields.NewsSourceSystem field) {
		return isSetField(field);
	}

	public boolean isSetNewsSourceSystem() {
		return isSetField(10146);
	}
