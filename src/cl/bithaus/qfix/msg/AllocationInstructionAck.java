...
public class AllocationInstructionAck extends Message {
	...
	public AllocationInstructionAck(cl.bithaus.qfix.fields.AllocID allocID, cl.bithaus.qfix.fields.TransactTime transactTime, cl.bithaus.qfix.fields.AllocStatus allocStatus) {
		this();
		setField(allocID);
