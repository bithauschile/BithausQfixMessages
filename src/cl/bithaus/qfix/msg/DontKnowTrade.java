...
public class DontKnowTrade extends Message {
	...
	public DontKnowTrade(cl.bithaus.qfix.fields.OrderID orderID, cl.bithaus.qfix.fields.ExecID execID, cl.bithaus.qfix.fields.DKReason dKReason, cl.bithaus.qfix.fields.Side side) {
		this();
		setField(orderID);
		setField(execID);
		setField(dKReason);
	...
	public void set(cl.bithaus.qfix.fields.DKReason value) {
		setField(value);
	}

	public cl.bithaus.qfix.fields.DKReason get(cl.bithaus.qfix.fields.DKReason value) throws FieldNotFound {
		getField(value);
		return value;
	}

	public cl.bithaus.qfix.fields.DKReason getDKReason() throws FieldNotFound {
		return get(new cl.bithaus.qfix.fields.DKReason());
	}

	public boolean isSet(cl.bithaus.qfix.fields.DKReason field) {
		return isSetField(field);
	}
