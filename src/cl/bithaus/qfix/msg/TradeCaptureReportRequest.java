...
public class TradeCaptureReportRequest extends Message {
	...
	public TradeCaptureReportRequest(cl.bithaus.qfix.fields.TradeRequestID tradeRequestID, cl.bithaus.qfix.fields.TradeRequestType tradeRequestType) {
		this();
	...
	public void set(cl.bithaus.qfix.fields.NoDates value) {
		setField(value);
	}

	public cl.bithaus.qfix.fields.NoDates get(cl.bithaus.qfix.fields.NoDates value) throws FieldNotFound {
		getField(value);
		return value;
	}

	public cl.bithaus.qfix.fields.NoDates getNoDates() throws FieldNotFound {
		return get(new cl.bithaus.qfix.fields.NoDates());
	}

	public boolean isSet(cl.bithaus.qfix.fields.NoDates field) {
		return isSetField(field);
	}
