...
public class QuoteCancel extends Message {
	...
	public QuoteCancel(cl.bithaus.qfix.fields.QuoteID quoteID, cl.bithaus.qfix.fields.QuoteCancelType quoteCancelType) {
		this();
		setField(quoteID);
	...
	public void set(cl.bithaus.qfix.fields.QuoteCancelType value) {
		setField(value);
	}

	public cl.bithaus.qfix.fields.QuoteCancelType get(cl.bithaus.qfix.fields.QuoteCancelType value) throws FieldNotFound {
		getField(value);
		return value;
	}

	public cl.bithaus.qfix.fields.QuoteCancelType getQuoteCancelType() throws FieldNotFound {
		return get(new cl.bithaus.qfix.fields.QuoteCancelType());
	}

	public boolean isSet(cl.bithaus.qfix.fields.QuoteCancelType field) {
		return isSetField(field);
	}
	...
	public static class NoQuoteEntries extends Group {
		...
		static final long serialVersionUID = 20050617;
		private static final int[] ORDER = {55, 65, 48, 22, 454, 460, 461, 167, 762, 200, 541, 224, 225, 239, 226, 227, 228, 255, 543, 470, 471, 472, 240, 202, 947, 206, 231, 223, 207, 106, 348, 349, 107, 350, 351, 691, 667, 875, 876, 864, 873, 874, 10160, 10161, 10162, 10225, 10224, 10165, 10166, 10174, 10176, 10228, 10229, 913, 914, 915, 918, 788, 916, 917, 919, 898, 711, 555, 0};
