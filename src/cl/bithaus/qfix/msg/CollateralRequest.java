...
public class CollateralRequest extends Message {
	...
	public CollateralRequest(cl.bithaus.qfix.fields.CollReqID collReqID, cl.bithaus.qfix.fields.CollAsgnReason collAsgnReason, cl.bithaus.qfix.fields.TransactTime transactTime) {
		this();
		setField(collReqID);
