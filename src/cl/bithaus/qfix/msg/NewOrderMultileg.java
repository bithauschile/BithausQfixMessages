...
public class NewOrderMultileg extends Message {
	...
	public NewOrderMultileg(cl.bithaus.qfix.fields.ClOrdID clOrdID, cl.bithaus.qfix.fields.Side side, cl.bithaus.qfix.fields.TransactTime transactTime, cl.bithaus.qfix.fields.OrdType ordType) {
		this();
		setField(clOrdID);
		setField(side);
