...
public class ListStrikePrice extends Message {
	...
	public ListStrikePrice(cl.bithaus.qfix.fields.ListID listID, cl.bithaus.qfix.fields.TotNoStrikes totNoStrikes) {
		this();
		setField(listID);
	...
	public void set(cl.bithaus.qfix.fields.TotNoStrikes value) {
		setField(value);
	}

	public cl.bithaus.qfix.fields.TotNoStrikes get(cl.bithaus.qfix.fields.TotNoStrikes value) throws FieldNotFound {
		getField(value);
		return value;
	}

	public cl.bithaus.qfix.fields.TotNoStrikes getTotNoStrikes() throws FieldNotFound {
		return get(new cl.bithaus.qfix.fields.TotNoStrikes());
	}

	public boolean isSet(cl.bithaus.qfix.fields.TotNoStrikes field) {
		return isSetField(field);
	}
	...
	public void set(cl.bithaus.qfix.fields.NoStrikes value) {
		setField(value);
	}

	public cl.bithaus.qfix.fields.NoStrikes get(cl.bithaus.qfix.fields.NoStrikes value) throws FieldNotFound {
		getField(value);
		return value;
	}

	public cl.bithaus.qfix.fields.NoStrikes getNoStrikes() throws FieldNotFound {
		return get(new cl.bithaus.qfix.fields.NoStrikes());
	}

	public boolean isSet(cl.bithaus.qfix.fields.NoStrikes field) {
		return isSetField(field);
	}
	...
	public static class NoUnderlyings extends Group {
		...
		static final long serialVersionUID = 20050617;
		private static final int[] ORDER = {311, 312, 309, 305, 457, 462, 463, 310, 763, 313, 542, 241, 242, 243, 244, 245, 246, 256, 595, 592, 593, 594, 247, 316, 941, 317, 436, 435, 308, 306, 362, 363, 307, 364, 365, 877, 878, 318, 879, 810, 882, 883, 884, 885, 886, 887, 140, 11, 526, 54, 44, 15, 58, 354, 355, 0};
