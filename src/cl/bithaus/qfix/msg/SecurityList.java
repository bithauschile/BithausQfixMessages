...
public class SecurityList extends Message {
	...
	public SecurityList(cl.bithaus.qfix.fields.SecurityReqID securityReqID, cl.bithaus.qfix.fields.SecurityResponseID securityResponseID, cl.bithaus.qfix.fields.SecurityRequestResult securityRequestResult) {
		this();
	...
	public static class NoRelatedSym extends Group {
		...
		static final long serialVersionUID = 20050617;
		private static final int[] ORDER = {55, 65, 48, 22, 454, 460, 461, 167, 762, 200, 541, 224, 225, 239, 226, 227, 228, 255, 543, 470, 471, 472, 240, 202, 947, 206, 231, 223, 207, 106, 348, 349, 107, 350, 351, 691, 667, 875, 876, 864, 873, 874, 10160, 10161, 10162, 10225, 10224, 10165, 10166, 10174, 10176, 10228, 10229, 668, 869, 870, 913, 914, 915, 918, 788, 916, 917, 919, 898, 711, 15, 232, 555, 218, 220, 221, 222, 662, 663, 699, 761, 235, 236, 701, 696, 697, 698, 561, 562, 336, 625, 827, 58, 354, 355, 10134, 10135, 10136, 10137, 423, 10159, 10163, 0};
	...
	public void set(cl.bithaus.qfix.fields.RoundLot value) {
		setField(value);
	}

	public cl.bithaus.qfix.fields.RoundLot get(cl.bithaus.qfix.fields.RoundLot value) throws FieldNotFound {
		getField(value);
		return value;
	}

	public cl.bithaus.qfix.fields.RoundLot getRoundLot() throws FieldNotFound {
		return get(new cl.bithaus.qfix.fields.RoundLot());
	}

	public boolean isSet(cl.bithaus.qfix.fields.RoundLot field) {
		return isSetField(field);
	}
	...
	public void set(cl.bithaus.qfix.fields.MinTradeVol value) {
		setField(value);
	}

	public cl.bithaus.qfix.fields.MinTradeVol get(cl.bithaus.qfix.fields.MinTradeVol value) throws FieldNotFound {
		getField(value);
		return value;
	}

	public cl.bithaus.qfix.fields.MinTradeVol getMinTradeVol() throws FieldNotFound {
		return get(new cl.bithaus.qfix.fields.MinTradeVol());
	}

	public boolean isSet(cl.bithaus.qfix.fields.MinTradeVol field) {
		return isSetField(field);
	}
	...
	public void set(cl.bithaus.qfix.fields.ExpirationCycle value) {
		setField(value);
	}

	public cl.bithaus.qfix.fields.ExpirationCycle get(cl.bithaus.qfix.fields.ExpirationCycle value) throws FieldNotFound {
		getField(value);
		return value;
	}

	public cl.bithaus.qfix.fields.ExpirationCycle getExpirationCycle() throws FieldNotFound {
		return get(new cl.bithaus.qfix.fields.ExpirationCycle());
	}

	public boolean isSet(cl.bithaus.qfix.fields.ExpirationCycle field) {
		return isSetField(field);
	}
	...
	public void set(cl.bithaus.qfix.fields.PresenceCategory value) {
		setField(value);
	}

	public cl.bithaus.qfix.fields.PresenceCategory get(cl.bithaus.qfix.fields.PresenceCategory value) throws FieldNotFound {
		getField(value);
		return value;
	}

	public cl.bithaus.qfix.fields.PresenceCategory getPresenceCategory() throws FieldNotFound {
		return get(new cl.bithaus.qfix.fields.PresenceCategory());
	}

	public boolean isSet(cl.bithaus.qfix.fields.PresenceCategory field) {
		return isSetField(field);
	}

	public boolean isSetPresenceCategory() {
		return isSetField(10134);
	}

	public void set(cl.bithaus.qfix.fields.AutomaticCrossAuthorization value) {
		setField(value);
	}

	public cl.bithaus.qfix.fields.AutomaticCrossAuthorization get(cl.bithaus.qfix.fields.AutomaticCrossAuthorization value) throws FieldNotFound {
		getField(value);
		return value;
	}

	public cl.bithaus.qfix.fields.AutomaticCrossAuthorization getAutomaticCrossAuthorization() throws FieldNotFound {
		return get(new cl.bithaus.qfix.fields.AutomaticCrossAuthorization());
	}

	public boolean isSet(cl.bithaus.qfix.fields.AutomaticCrossAuthorization field) {
		return isSetField(field);
	}

	public boolean isSetAutomaticCrossAuthorization() {
		return isSetField(10135);
	}

	public void set(cl.bithaus.qfix.fields.NumericPresence value) {
		setField(value);
	}

	public cl.bithaus.qfix.fields.NumericPresence get(cl.bithaus.qfix.fields.NumericPresence value) throws FieldNotFound {
		getField(value);
		return value;
	}

	public cl.bithaus.qfix.fields.NumericPresence getNumericPresence() throws FieldNotFound {
		return get(new cl.bithaus.qfix.fields.NumericPresence());
	}

	public boolean isSet(cl.bithaus.qfix.fields.NumericPresence field) {
		return isSetField(field);
	}

	public boolean isSetNumericPresence() {
		return isSetField(10136);
	}

	public void set(cl.bithaus.qfix.fields.SerializedAuthorization value) {
		setField(value);
	}

	public cl.bithaus.qfix.fields.SerializedAuthorization get(cl.bithaus.qfix.fields.SerializedAuthorization value) throws FieldNotFound {
		getField(value);
		return value;
	}

	public cl.bithaus.qfix.fields.SerializedAuthorization getSerializedAuthorization() throws FieldNotFound {
		return get(new cl.bithaus.qfix.fields.SerializedAuthorization());
	}

	public boolean isSet(cl.bithaus.qfix.fields.SerializedAuthorization field) {
		return isSetField(field);
	}

	public boolean isSetSerializedAuthorization() {
		return isSetField(10137);
	}
