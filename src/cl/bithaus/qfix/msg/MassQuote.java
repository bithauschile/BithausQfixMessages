...
public class MassQuote extends Message {
	...
	public MassQuote(cl.bithaus.qfix.fields.QuoteID quoteID) {
		this();
		setField(quoteID);
	}
	...
	public void set(cl.bithaus.qfix.fields.DefBidSize value) {
		setField(value);
	}

	public cl.bithaus.qfix.fields.DefBidSize get(cl.bithaus.qfix.fields.DefBidSize value) throws FieldNotFound {
		getField(value);
		return value;
	}

	public cl.bithaus.qfix.fields.DefBidSize getDefBidSize() throws FieldNotFound {
		return get(new cl.bithaus.qfix.fields.DefBidSize());
	}

	public boolean isSet(cl.bithaus.qfix.fields.DefBidSize field) {
		return isSetField(field);
	}
	...
	public void set(cl.bithaus.qfix.fields.DefOfferSize value) {
		setField(value);
	}

	public cl.bithaus.qfix.fields.DefOfferSize get(cl.bithaus.qfix.fields.DefOfferSize value) throws FieldNotFound {
		getField(value);
		return value;
	}

	public cl.bithaus.qfix.fields.DefOfferSize getDefOfferSize() throws FieldNotFound {
		return get(new cl.bithaus.qfix.fields.DefOfferSize());
	}

	public boolean isSet(cl.bithaus.qfix.fields.DefOfferSize field) {
		return isSetField(field);
	}
	...
	public static class NoQuoteSets extends Group {
		...
		static final long serialVersionUID = 20050617;
		private static final int[] ORDER = {302, 311, 312, 309, 305, 457, 462, 463, 310, 763, 313, 542, 241, 242, 243, 244, 245, 246, 256, 595, 592, 593, 594, 247, 316, 941, 317, 436, 435, 308, 306, 362, 363, 307, 364, 365, 877, 878, 318, 879, 810, 882, 883, 884, 885, 886, 887, 367, 304, 893, 295, 0};
	...
	public void set(cl.bithaus.qfix.fields.QuoteSetValidUntilTime value) {
		setField(value);
	}

	public cl.bithaus.qfix.fields.QuoteSetValidUntilTime get(cl.bithaus.qfix.fields.QuoteSetValidUntilTime value) throws FieldNotFound {
		getField(value);
		return value;
	}

	public cl.bithaus.qfix.fields.QuoteSetValidUntilTime getQuoteSetValidUntilTime() throws FieldNotFound {
		return get(new cl.bithaus.qfix.fields.QuoteSetValidUntilTime());
	}

	public boolean isSet(cl.bithaus.qfix.fields.QuoteSetValidUntilTime field) {
		return isSetField(field);
	}
	...
	public static class NoQuoteEntries extends Group {
		...
		static final long serialVersionUID = 20050617;
		private static final int[] ORDER = {299, 55, 65, 48, 22, 454, 460, 461, 167, 762, 200, 541, 224, 225, 239, 226, 227, 228, 255, 543, 470, 471, 472, 240, 202, 947, 206, 231, 223, 207, 106, 348, 349, 107, 350, 351, 691, 667, 875, 876, 864, 873, 874, 10160, 10161, 10162, 10225, 10224, 10165, 10166, 10174, 10176, 10228, 10229, 555, 132, 133, 134, 135, 62, 188, 190, 189, 191, 631, 632, 633, 634, 60, 336, 625, 64, 40, 193, 192, 642, 643, 15, 0};
