...
/**
 * Fix - Bithaus format component translator for AllocationInstruction
...
public class AllocationInstructionTranslator  {
    ...
    public static cl.bithaus.fix.AllocationInstruction fromFix(cl.bithaus.qfix.msg.AllocationInstruction src) 
        throws FieldNotFound {

        cl.bithaus.fix.AllocationInstruction dest = new cl.bithaus.fix.AllocationInstruction();
        ...
        if(src.isSetNoOrders()) {
            ...
            List<cl.bithaus.fix.AllocationInstruction.NoOrders.NoOrdersEntry> result = new LinkedList<>();
            ...
            for(quickfix.Group g : gList) {
                ...
                cl.bithaus.fix.AllocationInstruction.NoOrders.NoOrdersEntry entry = 
                    new cl.bithaus.fix.AllocationInstruction.NoOrders.NoOrdersEntry();
        ...
        if(src.isSetNoExecs()) {
            ...
            List<cl.bithaus.fix.AllocationInstruction.NoExecs.NoExecsEntry> result = new LinkedList<>();
            ...
            for(quickfix.Group g : gList) {
                ...
                cl.bithaus.fix.AllocationInstruction.NoExecs.NoExecsEntry entry = 
                    new cl.bithaus.fix.AllocationInstruction.NoExecs.NoExecsEntry();
        ...
        if(src.isSetNoUnderlyings()) {
            ...
            List<cl.bithaus.fix.AllocationInstruction.NoUnderlyings.NoUnderlyingsEntry> result = new LinkedList<>();


            for(quickfix.Group g : gList) {

                cl.bithaus.fix.AllocationInstruction.NoUnderlyings.NoUnderlyingsEntry entry = 
                    new cl.bithaus.fix.AllocationInstruction.NoUnderlyings.NoUnderlyingsEntry();
        ...
        if(src.isSetNoLegs()) {
            ...
            List<cl.bithaus.fix.AllocationInstruction.NoLegs.NoLegsEntry> result = new LinkedList<>();


            for(quickfix.Group g : gList) {

                cl.bithaus.fix.AllocationInstruction.NoLegs.NoLegsEntry entry = 
                    new cl.bithaus.fix.AllocationInstruction.NoLegs.NoLegsEntry();
        ...
        if(src.isSetNoAllocs()) {
            ...
            List<cl.bithaus.fix.AllocationInstruction.NoAllocs.NoAllocsEntry> result = new LinkedList<>();
            ...
            cl.bithaus.qfix.fields.NoClearingInstructions noClearingInstructions = new cl.bithaus.qfix.fields.NoClearingInstructions();
            cl.bithaus.qfix.fields.ClearingInstruction clearingInstruction = new cl.bithaus.qfix.fields.ClearingInstruction();
            ...
            for(quickfix.Group g : gList) {
                ...
                cl.bithaus.fix.AllocationInstruction.NoAllocs.NoAllocsEntry entry = 
                    new cl.bithaus.fix.AllocationInstruction.NoAllocs.NoAllocsEntry();
                ...
                if(g.isSetField(noClearingInstructions)) {
                    noClearingInstructions = (cl.bithaus.qfix.fields.NoClearingInstructions) g.getField(noClearingInstructions);
                    entry.setNoClearingInstructions(noClearingInstructions.getValue());

                }
                if(g.isSetField(clearingInstruction)) {
                    clearingInstruction = (cl.bithaus.qfix.fields.ClearingInstruction) g.getField(clearingInstruction);
                    entry.setClearingInstruction(clearingInstruction.getValue());
