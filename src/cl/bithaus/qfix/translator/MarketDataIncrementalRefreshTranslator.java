...
/**
 * Fix - Bithaus format component translator for MarketDataIncrementalRefresh
 * Generated for FIX 4.4
 * @author Bithaus Fix Message Generator
 */
public class MarketDataIncrementalRefreshTranslator  {

    public static cl.bithaus.qfix.msg.MarketDataIncrementalRefresh toFix(cl.bithaus.fix.MarketDataIncrementalRefresh src) {

        cl.bithaus.qfix.msg.MarketDataIncrementalRefresh dest = new cl.bithaus.qfix.msg.MarketDataIncrementalRefresh();
        ...
        if(src.getNoMDEntries() != null && src.getNoMDEntries().size() > 0) {
            ...
            for(cl.bithaus.fix.MarketDataIncrementalRefresh.NoMDEntries.NoMDEntriesEntry entry : src.getNoMDEntries().getGroups()) {

                cl.bithaus.qfix.msg.MarketDataIncrementalRefresh.NoMDEntries aux = 
                    new cl.bithaus.qfix.msg.MarketDataIncrementalRefresh.NoMDEntries();

                if(entry.getMDUpdateAction().length() > 0)
                    aux.set(new cl.bithaus.qfix.fields.MDUpdateAction(entry.getMDUpdateAction().charAt(0)));
                if(entry.getDeleteReason().length() > 0)
                    aux.set(new cl.bithaus.qfix.fields.DeleteReason(entry.getDeleteReason().charAt(0)));
                ...
                aux.set(new cl.bithaus.qfix.fields.FinancialStatus(entry.getFinancialStatus()));
                aux.set(new cl.bithaus.qfix.fields.CorporateAction(entry.getCorporateAction()));
                ...
                aux.set(new cl.bithaus.qfix.fields.NetChgPrevDay(entry.getNetChgPrevDay()));
    ...
    public static cl.bithaus.fix.MarketDataIncrementalRefresh fromFix(cl.bithaus.qfix.msg.MarketDataIncrementalRefresh src) 
        throws FieldNotFound {

        cl.bithaus.fix.MarketDataIncrementalRefresh dest = new cl.bithaus.fix.MarketDataIncrementalRefresh();
        ...
        if(src.isSetNoMDEntries()) {
            ...
            List<cl.bithaus.fix.MarketDataIncrementalRefresh.NoMDEntries.NoMDEntriesEntry> result = new LinkedList<>();

            cl.bithaus.qfix.fields.MDUpdateAction mDUpdateAction = new cl.bithaus.qfix.fields.MDUpdateAction();
            cl.bithaus.qfix.fields.DeleteReason deleteReason = new cl.bithaus.qfix.fields.DeleteReason();
            ...
            cl.bithaus.qfix.fields.FinancialStatus financialStatus = new cl.bithaus.qfix.fields.FinancialStatus();
            cl.bithaus.qfix.fields.CorporateAction corporateAction = new cl.bithaus.qfix.fields.CorporateAction();
            ...
            cl.bithaus.qfix.fields.NetChgPrevDay netChgPrevDay = new cl.bithaus.qfix.fields.NetChgPrevDay();
            ...
            for(quickfix.Group g : gList) {
                ...
                cl.bithaus.fix.MarketDataIncrementalRefresh.NoMDEntries.NoMDEntriesEntry entry = 
                    new cl.bithaus.fix.MarketDataIncrementalRefresh.NoMDEntries.NoMDEntriesEntry();

                if(g.isSetField(mDUpdateAction)) {
                    mDUpdateAction = (cl.bithaus.qfix.fields.MDUpdateAction) g.getField(mDUpdateAction);
                    entry.setMDUpdateAction(mDUpdateAction.getValue()+"");
                }
                if(g.isSetField(deleteReason)) {
                    deleteReason = (cl.bithaus.qfix.fields.DeleteReason) g.getField(deleteReason);
                    entry.setDeleteReason(deleteReason.getValue()+"");
                }
                ...
                if(g.isSetField(financialStatus)) {
                    financialStatus = (cl.bithaus.qfix.fields.FinancialStatus) g.getField(financialStatus);
                    entry.setFinancialStatus(financialStatus.getValue());

                }
                if(g.isSetField(corporateAction)) {
                    corporateAction = (cl.bithaus.qfix.fields.CorporateAction) g.getField(corporateAction);
                    entry.setCorporateAction(corporateAction.getValue());
                ...
                if(g.isSetField(netChgPrevDay)) {
                    netChgPrevDay = (cl.bithaus.qfix.fields.NetChgPrevDay) g.getField(netChgPrevDay);
                    entry.setNetChgPrevDay(netChgPrevDay.getValue());
