...
/**
 * Fix - Bithaus format component translator for CollateralResponse
...
public class CollateralResponseTranslator  {
    ...
    public static cl.bithaus.fix.CollateralResponse fromFix(cl.bithaus.qfix.msg.CollateralResponse src) 
        throws FieldNotFound {

        cl.bithaus.fix.CollateralResponse dest = new cl.bithaus.fix.CollateralResponse();

        if(src.isSetCollRespID())
            dest.setCollRespID(src.getCollRespID().getValue());
        ...
        if(src.isSetCollAsgnRespType())
            dest.setCollAsgnRespType(src.getCollAsgnRespType().getValue());

        if(src.isSetCollAsgnRejectReason())
            dest.setCollAsgnRejectReason(src.getCollAsgnRejectReason().getValue());
        ...
        if(src.isSetNoExecs()) {
            ...
            List<cl.bithaus.fix.CollateralResponse.NoExecs.NoExecsEntry> result = new LinkedList<>();

            cl.bithaus.qfix.fields.ExecID execID = new cl.bithaus.qfix.fields.ExecID();

            for(quickfix.Group g : gList) {

                cl.bithaus.fix.CollateralResponse.NoExecs.NoExecsEntry entry = 
                    new cl.bithaus.fix.CollateralResponse.NoExecs.NoExecsEntry();
        ...
        if(src.isSetNoTrades()) {
            ...
            List<cl.bithaus.fix.CollateralResponse.NoTrades.NoTradesEntry> result = new LinkedList<>();
            ...
            for(quickfix.Group g : gList) {
                ...
                cl.bithaus.fix.CollateralResponse.NoTrades.NoTradesEntry entry = 
                    new cl.bithaus.fix.CollateralResponse.NoTrades.NoTradesEntry();
        ...
        if(src.isSetNoUnderlyings()) {
            ...
            List<cl.bithaus.fix.CollateralResponse.NoUnderlyings.NoUnderlyingsEntry> result = new LinkedList<>();

            cl.bithaus.qfix.fields.CollAction collAction = new cl.bithaus.qfix.fields.CollAction();

            for(quickfix.Group g : gList) {

                cl.bithaus.fix.CollateralResponse.NoUnderlyings.NoUnderlyingsEntry entry = 
                    new cl.bithaus.fix.CollateralResponse.NoUnderlyings.NoUnderlyingsEntry();
        ...
        if(src.isSetNoMiscFees()) {
            ...
            List<cl.bithaus.fix.CollateralResponse.NoMiscFees.NoMiscFeesEntry> result = new LinkedList<>();
            ...
            for(quickfix.Group g : gList) {
                ...
                cl.bithaus.fix.CollateralResponse.NoMiscFees.NoMiscFeesEntry entry = 
                    new cl.bithaus.fix.CollateralResponse.NoMiscFees.NoMiscFeesEntry();
