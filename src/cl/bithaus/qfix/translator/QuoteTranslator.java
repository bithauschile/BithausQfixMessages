...
/**
 * Fix - Bithaus format component translator for Quote
...
public class QuoteTranslator  {
    ...
    public static cl.bithaus.fix.Quote fromFix(cl.bithaus.qfix.msg.Quote src) 
        throws FieldNotFound {

        cl.bithaus.fix.Quote dest = new cl.bithaus.fix.Quote();
        ...
        if(src.isSetNoQuoteQualifiers()) {
            ...
            List<cl.bithaus.fix.Quote.NoQuoteQualifiers.NoQuoteQualifiersEntry> result = new LinkedList<>();

            cl.bithaus.qfix.fields.QuoteQualifier quoteQualifier = new cl.bithaus.qfix.fields.QuoteQualifier();

            for(quickfix.Group g : gList) {

                cl.bithaus.fix.Quote.NoQuoteQualifiers.NoQuoteQualifiersEntry entry = 
                    new cl.bithaus.fix.Quote.NoQuoteQualifiers.NoQuoteQualifiersEntry();
        ...
        if(src.isSetNoUnderlyings()) {
            ...
            List<cl.bithaus.fix.Quote.NoUnderlyings.NoUnderlyingsEntry> result = new LinkedList<>();


            for(quickfix.Group g : gList) {

                cl.bithaus.fix.Quote.NoUnderlyings.NoUnderlyingsEntry entry = 
                    new cl.bithaus.fix.Quote.NoUnderlyings.NoUnderlyingsEntry();
        ...
        if(src.isSetNoLegs()) {
            ...
            List<cl.bithaus.fix.Quote.NoLegs.NoLegsEntry> result = new LinkedList<>();
            ...
            for(quickfix.Group g : gList) {
                ...
                cl.bithaus.fix.Quote.NoLegs.NoLegsEntry entry = 
                    new cl.bithaus.fix.Quote.NoLegs.NoLegsEntry();
