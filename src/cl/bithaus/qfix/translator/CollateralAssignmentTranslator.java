...
/**
 * Fix - Bithaus format component translator for CollateralAssignment
 * Generated for FIX 4.4
 * @author Bithaus Fix Message Generator
 */
public class CollateralAssignmentTranslator  {

    public static cl.bithaus.qfix.msg.CollateralAssignment toFix(cl.bithaus.fix.CollateralAssignment src) {

        cl.bithaus.qfix.msg.CollateralAssignment dest = new cl.bithaus.qfix.msg.CollateralAssignment();
        ...
        if(src.getCollAsgnRefID() != null)
            dest.set(new cl.bithaus.qfix.fields.CollAsgnRefID(src.getCollAsgnRefID()));
        ...
        if(src.getNoExecs() != null && src.getNoExecs().size() > 0) {
            ...
            for(cl.bithaus.fix.CollateralAssignment.NoExecs.NoExecsEntry entry : src.getNoExecs().getGroups()) {

                cl.bithaus.qfix.msg.CollateralAssignment.NoExecs aux = 
                    new cl.bithaus.qfix.msg.CollateralAssignment.NoExecs();
        ...
        if(src.getNoTrades() != null && src.getNoTrades().size() > 0) {
            ...
            for(cl.bithaus.fix.CollateralAssignment.NoTrades.NoTradesEntry entry : src.getNoTrades().getGroups()) {

                cl.bithaus.qfix.msg.CollateralAssignment.NoTrades aux = 
                    new cl.bithaus.qfix.msg.CollateralAssignment.NoTrades();
        ...
        if(src.getNoUnderlyings() != null && src.getNoUnderlyings().size() > 0) {
            ...
            for(cl.bithaus.fix.CollateralAssignment.NoUnderlyings.NoUnderlyingsEntry entry : src.getNoUnderlyings().getGroups()) {

                cl.bithaus.qfix.msg.CollateralAssignment.NoUnderlyings aux = 
                    new cl.bithaus.qfix.msg.CollateralAssignment.NoUnderlyings();
        ...
        if(src.getNoMiscFees() != null && src.getNoMiscFees().size() > 0) {
            ...
            for(cl.bithaus.fix.CollateralAssignment.NoMiscFees.NoMiscFeesEntry entry : src.getNoMiscFees().getGroups()) {

                cl.bithaus.qfix.msg.CollateralAssignment.NoMiscFees aux = 
                    new cl.bithaus.qfix.msg.CollateralAssignment.NoMiscFees();
    ...
    public static cl.bithaus.fix.CollateralAssignment fromFix(cl.bithaus.qfix.msg.CollateralAssignment src) 
        throws FieldNotFound {

        cl.bithaus.fix.CollateralAssignment dest = new cl.bithaus.fix.CollateralAssignment();

        if(src.isSetCollAsgnID())
            dest.setCollAsgnID(src.getCollAsgnID().getValue());

        if(src.isSetCollReqID())
            dest.setCollReqID(src.getCollReqID().getValue());

        if(src.isSetCollAsgnReason())
            dest.setCollAsgnReason(src.getCollAsgnReason().getValue());

        if(src.isSetCollAsgnTransType())
            dest.setCollAsgnTransType(src.getCollAsgnTransType().getValue());

        if(src.isSetCollAsgnRefID())
            dest.setCollAsgnRefID(src.getCollAsgnRefID().getValue());
        ...
        if(src.isSetNoExecs()) {
            ...
            List<cl.bithaus.fix.CollateralAssignment.NoExecs.NoExecsEntry> result = new LinkedList<>();

            cl.bithaus.qfix.fields.ExecID execID = new cl.bithaus.qfix.fields.ExecID();

            for(quickfix.Group g : gList) {

                cl.bithaus.fix.CollateralAssignment.NoExecs.NoExecsEntry entry = 
                    new cl.bithaus.fix.CollateralAssignment.NoExecs.NoExecsEntry();
        ...
        if(src.isSetNoTrades()) {
            ...
            List<cl.bithaus.fix.CollateralAssignment.NoTrades.NoTradesEntry> result = new LinkedList<>();
            ...
            for(quickfix.Group g : gList) {
                ...
                cl.bithaus.fix.CollateralAssignment.NoTrades.NoTradesEntry entry = 
                    new cl.bithaus.fix.CollateralAssignment.NoTrades.NoTradesEntry();
        ...
        if(src.isSetNoUnderlyings()) {
            ...
            List<cl.bithaus.fix.CollateralAssignment.NoUnderlyings.NoUnderlyingsEntry> result = new LinkedList<>();

            cl.bithaus.qfix.fields.CollAction collAction = new cl.bithaus.qfix.fields.CollAction();

            for(quickfix.Group g : gList) {

                cl.bithaus.fix.CollateralAssignment.NoUnderlyings.NoUnderlyingsEntry entry = 
                    new cl.bithaus.fix.CollateralAssignment.NoUnderlyings.NoUnderlyingsEntry();

                if(g.isSetField(collAction)) {
                    collAction = (cl.bithaus.qfix.fields.CollAction) g.getField(collAction);
                    entry.setCollAction(collAction.getValue());
        ...
        if(src.isSetNoMiscFees()) {
            ...
            List<cl.bithaus.fix.CollateralAssignment.NoMiscFees.NoMiscFeesEntry> result = new LinkedList<>();
            ...
            for(quickfix.Group g : gList) {
                ...
                cl.bithaus.fix.CollateralAssignment.NoMiscFees.NoMiscFeesEntry entry = 
                    new cl.bithaus.fix.CollateralAssignment.NoMiscFees.NoMiscFeesEntry();
