...
/**
 * Fix - Bithaus format component translator for MultilegOrderCancelReplaceRequest
 * Generated for FIX 4.4
 * @author Bithaus Fix Message Generator
 */
public class MultilegOrderCancelReplaceRequestTranslator  {

    public static cl.bithaus.qfix.msg.MultilegOrderCancelReplaceRequest toFix(cl.bithaus.fix.MultilegOrderCancelReplaceRequest src) {

        cl.bithaus.qfix.msg.MultilegOrderCancelReplaceRequest dest = new cl.bithaus.qfix.msg.MultilegOrderCancelReplaceRequest();
        ...
        if(src.getNoAllocs() != null && src.getNoAllocs().size() > 0) {
            ...
            for(cl.bithaus.fix.MultilegOrderCancelReplaceRequest.NoAllocs.NoAllocsEntry entry : src.getNoAllocs().getGroups()) {

                cl.bithaus.qfix.msg.MultilegOrderCancelReplaceRequest.NoAllocs aux = 
                    new cl.bithaus.qfix.msg.MultilegOrderCancelReplaceRequest.NoAllocs();
        ...
        if(src.getNoTradingSessions() != null && src.getNoTradingSessions().size() > 0) {
            ...
            for(cl.bithaus.fix.MultilegOrderCancelReplaceRequest.NoTradingSessions.NoTradingSessionsEntry entry : src.getNoTradingSessions().getGroups()) {

                cl.bithaus.qfix.msg.MultilegOrderCancelReplaceRequest.NoTradingSessions aux = 
                    new cl.bithaus.qfix.msg.MultilegOrderCancelReplaceRequest.NoTradingSessions();
        ...
        if(src.getNoUnderlyings() != null && src.getNoUnderlyings().size() > 0) {
            ...
            for(cl.bithaus.fix.MultilegOrderCancelReplaceRequest.NoUnderlyings.NoUnderlyingsEntry entry : src.getNoUnderlyings().getGroups()) {

                cl.bithaus.qfix.msg.MultilegOrderCancelReplaceRequest.NoUnderlyings aux = 
                    new cl.bithaus.qfix.msg.MultilegOrderCancelReplaceRequest.NoUnderlyings();
        ...
        if(src.getNoLegs() != null && src.getNoLegs().size() > 0) {
            ...
            for(cl.bithaus.fix.MultilegOrderCancelReplaceRequest.NoLegs.NoLegsEntry entry : src.getNoLegs().getGroups()) {

                cl.bithaus.qfix.msg.MultilegOrderCancelReplaceRequest.NoLegs aux = 
                    new cl.bithaus.qfix.msg.MultilegOrderCancelReplaceRequest.NoLegs();
    ...
    public static cl.bithaus.fix.MultilegOrderCancelReplaceRequest fromFix(cl.bithaus.qfix.msg.MultilegOrderCancelReplaceRequest src) 
        throws FieldNotFound {

        cl.bithaus.fix.MultilegOrderCancelReplaceRequest dest = new cl.bithaus.fix.MultilegOrderCancelReplaceRequest();
        ...
        if(src.isSetNoAllocs()) {
            ...
            List<cl.bithaus.fix.MultilegOrderCancelReplaceRequest.NoAllocs.NoAllocsEntry> result = new LinkedList<>();
            ...
            for(quickfix.Group g : gList) {
                ...
                cl.bithaus.fix.MultilegOrderCancelReplaceRequest.NoAllocs.NoAllocsEntry entry = 
                    new cl.bithaus.fix.MultilegOrderCancelReplaceRequest.NoAllocs.NoAllocsEntry();
        ...
        if(src.isSetNoTradingSessions()) {
            ...
            List<cl.bithaus.fix.MultilegOrderCancelReplaceRequest.NoTradingSessions.NoTradingSessionsEntry> result = new LinkedList<>();
            ...
            for(quickfix.Group g : gList) {
                ...
                cl.bithaus.fix.MultilegOrderCancelReplaceRequest.NoTradingSessions.NoTradingSessionsEntry entry = 
                    new cl.bithaus.fix.MultilegOrderCancelReplaceRequest.NoTradingSessions.NoTradingSessionsEntry();
        ...
        if(src.isSetNoUnderlyings()) {
            ...
            List<cl.bithaus.fix.MultilegOrderCancelReplaceRequest.NoUnderlyings.NoUnderlyingsEntry> result = new LinkedList<>();


            for(quickfix.Group g : gList) {

                cl.bithaus.fix.MultilegOrderCancelReplaceRequest.NoUnderlyings.NoUnderlyingsEntry entry = 
                    new cl.bithaus.fix.MultilegOrderCancelReplaceRequest.NoUnderlyings.NoUnderlyingsEntry();
        ...
        if(src.isSetNoLegs()) {
            ...
            List<cl.bithaus.fix.MultilegOrderCancelReplaceRequest.NoLegs.NoLegsEntry> result = new LinkedList<>();
            ...
            for(quickfix.Group g : gList) {
                ...
                cl.bithaus.fix.MultilegOrderCancelReplaceRequest.NoLegs.NoLegsEntry entry = 
                    new cl.bithaus.fix.MultilegOrderCancelReplaceRequest.NoLegs.NoLegsEntry();
