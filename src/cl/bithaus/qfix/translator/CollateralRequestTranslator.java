...
/**
 * Fix - Bithaus format component translator for CollateralRequest
...
public class CollateralRequestTranslator  {
    ...
    public static cl.bithaus.fix.CollateralRequest fromFix(cl.bithaus.qfix.msg.CollateralRequest src) 
        throws FieldNotFound {

        cl.bithaus.fix.CollateralRequest dest = new cl.bithaus.fix.CollateralRequest();
        ...
        if(src.isSetNoExecs()) {
            ...
            List<cl.bithaus.fix.CollateralRequest.NoExecs.NoExecsEntry> result = new LinkedList<>();

            cl.bithaus.qfix.fields.ExecID execID = new cl.bithaus.qfix.fields.ExecID();

            for(quickfix.Group g : gList) {

                cl.bithaus.fix.CollateralRequest.NoExecs.NoExecsEntry entry = 
                    new cl.bithaus.fix.CollateralRequest.NoExecs.NoExecsEntry();
        ...
        if(src.isSetNoTrades()) {
            ...
            List<cl.bithaus.fix.CollateralRequest.NoTrades.NoTradesEntry> result = new LinkedList<>();
            ...
            for(quickfix.Group g : gList) {
                ...
                cl.bithaus.fix.CollateralRequest.NoTrades.NoTradesEntry entry = 
                    new cl.bithaus.fix.CollateralRequest.NoTrades.NoTradesEntry();
        ...
        if(src.isSetNoUnderlyings()) {
            ...
            List<cl.bithaus.fix.CollateralRequest.NoUnderlyings.NoUnderlyingsEntry> result = new LinkedList<>();

            cl.bithaus.qfix.fields.CollAction collAction = new cl.bithaus.qfix.fields.CollAction();

            for(quickfix.Group g : gList) {

                cl.bithaus.fix.CollateralRequest.NoUnderlyings.NoUnderlyingsEntry entry = 
                    new cl.bithaus.fix.CollateralRequest.NoUnderlyings.NoUnderlyingsEntry();
        ...
        if(src.isSetNoMiscFees()) {
            ...
            List<cl.bithaus.fix.CollateralRequest.NoMiscFees.NoMiscFeesEntry> result = new LinkedList<>();
            ...
            for(quickfix.Group g : gList) {
                ...
                cl.bithaus.fix.CollateralRequest.NoMiscFees.NoMiscFeesEntry entry = 
                    new cl.bithaus.fix.CollateralRequest.NoMiscFees.NoMiscFeesEntry();
