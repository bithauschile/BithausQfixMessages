...
/**
 * Fix - Bithaus format component translator for QuoteResponse
 * Generated for FIX 4.4
 * @author Bithaus Fix Message Generator
 */
public class QuoteResponseTranslator  {

    public static cl.bithaus.qfix.msg.QuoteResponse toFix(cl.bithaus.fix.QuoteResponse src) {

        cl.bithaus.qfix.msg.QuoteResponse dest = new cl.bithaus.qfix.msg.QuoteResponse();
        ...
        if(src.getQuoteRespType() != null)
            dest.set(new cl.bithaus.qfix.fields.QuoteRespType(src.getQuoteRespType()));
        ...
        if(src.getNoQuoteQualifiers() != null && src.getNoQuoteQualifiers().size() > 0) {
            ...
            for(cl.bithaus.fix.QuoteResponse.NoQuoteQualifiers.NoQuoteQualifiersEntry entry : src.getNoQuoteQualifiers().getGroups()) {

                cl.bithaus.qfix.msg.QuoteResponse.NoQuoteQualifiers aux = 
                    new cl.bithaus.qfix.msg.QuoteResponse.NoQuoteQualifiers();
        ...
        if(src.getNoUnderlyings() != null && src.getNoUnderlyings().size() > 0) {
            ...
            for(cl.bithaus.fix.QuoteResponse.NoUnderlyings.NoUnderlyingsEntry entry : src.getNoUnderlyings().getGroups()) {

                cl.bithaus.qfix.msg.QuoteResponse.NoUnderlyings aux = 
                    new cl.bithaus.qfix.msg.QuoteResponse.NoUnderlyings();
        ...
        if(src.getNoLegs() != null && src.getNoLegs().size() > 0) {
            ...
            for(cl.bithaus.fix.QuoteResponse.NoLegs.NoLegsEntry entry : src.getNoLegs().getGroups()) {

                cl.bithaus.qfix.msg.QuoteResponse.NoLegs aux = 
                    new cl.bithaus.qfix.msg.QuoteResponse.NoLegs();
    ...
    public static cl.bithaus.fix.QuoteResponse fromFix(cl.bithaus.qfix.msg.QuoteResponse src) 
        throws FieldNotFound {

        cl.bithaus.fix.QuoteResponse dest = new cl.bithaus.fix.QuoteResponse();
        ...
        if(src.isSetQuoteRespType())
            dest.setQuoteRespType(src.getQuoteRespType().getValue());
        ...
        if(src.isSetNoQuoteQualifiers()) {
            ...
            List<cl.bithaus.fix.QuoteResponse.NoQuoteQualifiers.NoQuoteQualifiersEntry> result = new LinkedList<>();

            cl.bithaus.qfix.fields.QuoteQualifier quoteQualifier = new cl.bithaus.qfix.fields.QuoteQualifier();

            for(quickfix.Group g : gList) {

                cl.bithaus.fix.QuoteResponse.NoQuoteQualifiers.NoQuoteQualifiersEntry entry = 
                    new cl.bithaus.fix.QuoteResponse.NoQuoteQualifiers.NoQuoteQualifiersEntry();
        ...
        if(src.isSetNoUnderlyings()) {
            ...
            List<cl.bithaus.fix.QuoteResponse.NoUnderlyings.NoUnderlyingsEntry> result = new LinkedList<>();


            for(quickfix.Group g : gList) {

                cl.bithaus.fix.QuoteResponse.NoUnderlyings.NoUnderlyingsEntry entry = 
                    new cl.bithaus.fix.QuoteResponse.NoUnderlyings.NoUnderlyingsEntry();
        ...
        if(src.isSetNoLegs()) {
            ...
            List<cl.bithaus.fix.QuoteResponse.NoLegs.NoLegsEntry> result = new LinkedList<>();
            ...
            cl.bithaus.qfix.fields.LegPriceType legPriceType = new cl.bithaus.qfix.fields.LegPriceType();
            cl.bithaus.qfix.fields.LegBidPx legBidPx = new cl.bithaus.qfix.fields.LegBidPx();
            cl.bithaus.qfix.fields.LegOfferPx legOfferPx = new cl.bithaus.qfix.fields.LegOfferPx();

            for(quickfix.Group g : gList) {

                cl.bithaus.fix.QuoteResponse.NoLegs.NoLegsEntry entry = 
                    new cl.bithaus.fix.QuoteResponse.NoLegs.NoLegsEntry();
                ...
                if(g.isSetField(legPriceType)) {
                    legPriceType = (cl.bithaus.qfix.fields.LegPriceType) g.getField(legPriceType);
                    entry.setLegPriceType(legPriceType.getValue());

                }
                if(g.isSetField(legBidPx)) {
                    legBidPx = (cl.bithaus.qfix.fields.LegBidPx) g.getField(legBidPx);
                    entry.setLegBidPx(legBidPx.getValue());

                }
                if(g.isSetField(legOfferPx)) {
                    legOfferPx = (cl.bithaus.qfix.fields.LegOfferPx) g.getField(legOfferPx);
                    entry.setLegOfferPx(legOfferPx.getValue());
