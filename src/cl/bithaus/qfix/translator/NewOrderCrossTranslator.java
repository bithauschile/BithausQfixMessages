...
/**
 * Fix - Bithaus format component translator for NewOrderCross
...
public class NewOrderCrossTranslator  {
    ...
    public static cl.bithaus.fix.NewOrderCross fromFix(cl.bithaus.qfix.msg.NewOrderCross src) 
        throws FieldNotFound {

        cl.bithaus.fix.NewOrderCross dest = new cl.bithaus.fix.NewOrderCross();
        ...
        if(src.isSetNoSides()) {
            ...
            List<cl.bithaus.fix.NewOrderCross.NoSides.NoSidesEntry> result = new LinkedList<>();
            ...
            for(quickfix.Group g : gList) {
                ...
                cl.bithaus.fix.NewOrderCross.NoSides.NoSidesEntry entry = 
                    new cl.bithaus.fix.NewOrderCross.NoSides.NoSidesEntry();
        ...
        if(src.isSetNoUnderlyings()) {
            ...
            List<cl.bithaus.fix.NewOrderCross.NoUnderlyings.NoUnderlyingsEntry> result = new LinkedList<>();


            for(quickfix.Group g : gList) {

                cl.bithaus.fix.NewOrderCross.NoUnderlyings.NoUnderlyingsEntry entry = 
                    new cl.bithaus.fix.NewOrderCross.NoUnderlyings.NoUnderlyingsEntry();
        ...
        if(src.isSetNoLegs()) {
            ...
            List<cl.bithaus.fix.NewOrderCross.NoLegs.NoLegsEntry> result = new LinkedList<>();


            for(quickfix.Group g : gList) {

                cl.bithaus.fix.NewOrderCross.NoLegs.NoLegsEntry entry = 
                    new cl.bithaus.fix.NewOrderCross.NoLegs.NoLegsEntry();
